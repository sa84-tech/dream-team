...
import { gerUserDetails, getUserDetailsError, getUserDetailsIsLoading } from '../../model/selectors/userDetailsSelectors';
        ...
        <div className={classNames(cls.UserDetailsPage, {}, [className])}>
            ...
            <main className={cls.main}>
                ...
                <aside className={cls.contacts}>
                    <a className={cls.email} href={`email:${user?.email}`}><EmailIcon /> {user?.email}</a>
                    <a className={cls.phone} href={`tel:${user?.phone}`}><PhoneIcon /> +{user?.phone}</a>
                    </aside>
            </main>
